...
function getDisfrazEspecifico(idDisfraz) {
    $.ajax({
        url: 'https://gadd23a8b2081af-base1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/costume/costume/'+idDisfraz,
        type: 'GET',
        dataType: 'JSON',
        success: function(response){
...
$.ajax({
    url: 'https://gadd23a8b2081af-base1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/'+idCliente,
    type: 'GET',
    dataType: 'JSON',
    success: function(response){
        var item = response.items[0];
...
$.ajax({
    url: 'https://gadd23a8b2081af-base1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/open-api-catalog/message/'+idMensaje,
    type: 'GET',
    dataType: 'JSON',
    success: function(response){
        var item = response.items[0];
